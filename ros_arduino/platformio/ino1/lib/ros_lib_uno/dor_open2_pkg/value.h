#ifndef _ROS_SERVICE_value_h
#define _ROS_SERVICE_value_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"

namespace dor_open2_pkg
{

static const char VALUE[] = "dor_open2_pkg/value";

  class valueRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return VALUE; };
    virtual const char * getMD5() override { return "5fb9efaae516a11469b0f7d4bce676a6"; };

  };

  class valueResponse : public ros::Msg
  {
    public:
